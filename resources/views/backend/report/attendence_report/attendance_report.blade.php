...
@section('active_menu','Attendance Log')
@section('link','')
@section('content')
    
    <div class="card">
        <div class="card-header">
            @include('backend.report.attendence_report.attendance_history_search')
...
@push('js')
    ...
    @include('backend.report.attendence_report.attendance_report_js')
@endpush
