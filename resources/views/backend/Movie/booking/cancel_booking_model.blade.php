<div class="modal fade" id="cancel_model" tabindex="-1" role="dialog" aria-labelledby="cancel_model" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form action="" id="save_cancel_info">
                @csrf
                <div class="modal-header">
                    <h5 class="modal-title">Please write Cancellation reason properly</h5>
