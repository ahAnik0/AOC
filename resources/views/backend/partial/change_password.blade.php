        ...
        <div class="row justify-content-center">
            ...
            {{-- <div class="col-md-8">
                ...
                <div class="card">
                    ...
                    <div class="card-header">Update ceo image</div>
                    
                    <div class="card-body">
                        <form method="POST" action="{{route('admin.ceo_image')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group row">
                                <label for="current_password" class="col-md-4 col-form-label text-md-right">Current Password</label>
                                <img src="{{asset('uploads/setting/'.\App\Models\SettingModel::where('name','ceo_image')->first()->image)}}" alt="" height="100px" width="100px">
                                <div class="col-md-6">
