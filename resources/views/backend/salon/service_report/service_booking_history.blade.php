...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            @include('backend.salon.service_report.service_booking_history_search')
...
@push('js')
    ...
    @include('backend.salon.service_report.service_booking_history_js')
@endpush
