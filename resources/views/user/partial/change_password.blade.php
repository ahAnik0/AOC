        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('user.update_change_password') }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                <label for="password" class="col-md-4 col-form-label text-md-right">New Password <small class="text-danger">(Password needs to have at least 8 characters)
                                    </small></label>
