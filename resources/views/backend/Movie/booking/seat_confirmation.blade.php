...
@section('active_menu','Seat Confirm')
@section('content')
        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form-wizard" action="{{route('admin.movie/booking_submit',request()->id)}}" method="POST">
                            @csrf
                            ...
                            <div class="row align-items-center justify-content-center">
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <button class="btn btn-success" onclick="set_date()">Set Date</button>
                                    </div>
                                </div>
                            </div>
                            
                            
                            <input name="member_id" type="hidden" value="{{request()->id}}">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <span id="problem_typeError" class="text-red error_field"></span>
                    </div>
                    
                    {{--                            <div class="form-group">--}}
                    {{--                                <label for="exampleInputEmail1">Remarks</label>--}}
                    {{--                                <textarea name="remarks" class="form-control"></textarea>--}}
                    {{--                                <span id="problem_detailsError" class="text-red error_field"></span>--}}
                    {{--                            </div>--}}
                    
                    <div class="mb-3">
                        <label class="col-form-label">Amount</label>
                        <input class="form-control" type="text" name="amount" id="total_amount" readonly>
                        <span id="error_movie_name" class="text-danger error_field"></span>
                    </div>
                    <div class="row justify-content-center">
                        <button class="btn btn-primary btn-lg btn-block col-md-6 css_1" type="submit"  id="form_submission_button">
                            Save
                        </button>
                    </div>
                    </form>
