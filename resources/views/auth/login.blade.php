...
<head>
    ...
    <meta name="description"
          content="Army Officers Club">
    <meta name="keywords" content="Army Officers Club">
    <meta name="author" content="Army Officers Club">
    ...
    <title>Army Officers Club</title>
...
<section>
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-5">
                <img class="bg-img-cover bg-center" src="{{asset('assets/backend/images/logo/logo.PNG')}}" alt="looginpage" >
            </div>
                    ...
                    <form class="theme-form login-form" action="{{ route('login') }}" method="post">
                        ...
                        <div class="form-group">
                            <ul class="login-social">
                                <li class="css1">
                                    <img class="justify-content-center" src="{{asset('assets/backend/images/logo/logo.PNG')}}" alt="" height="100px;">
                                </li>
                            </ul>
                        </div>
