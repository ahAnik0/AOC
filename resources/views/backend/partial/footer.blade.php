    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6 footer-copyright">
                <p class="mb-0">{{ __('Copyright © '.date("Y").' | All Rights Reserved by Army Officers Club')}}</p>
            </div>
            <div class="col-md-6">
{{--                <p class="pull-right mb-0">Developed By <a href="https://portfolio-ratin.com/" target="_blank">Khasrur Rahman</a></p>--}}
            </div>
        </div>
    </div>
</footer>
...
<script src="{{asset('assets/backend/js/icons/feather-icon/feather-icon.js')}} "  nonce="{{ csp_nonce() }}"   crossorigin="anonymous"></script>
