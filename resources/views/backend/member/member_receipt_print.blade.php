...
<div id="invoice-POS">
    ...
    <div id="bot">
        ...
        <div id="table">
            <table class="text-center">
                ...
                <tr class="service">
                    ...
                    <td class="tableitem"><p class="itemtext">
                        {{\Illuminate\Support\Carbon::parse($data->created_at)->format('M d, Y')}}<br>
                        </p></td>
                </tr>
                <tr class="service">
                    <td class="tableitem">
                ...
                <tr class="service">
                    ...
                    <td class="tableitem">
                        <p class="itemtext">
                            <?php if ($data->pay_type == 0) {
                                echo 'Cash';
                            } elseif ($data->pay_type == 1) {
                                echo "Cheque <br>";  
                                echo 'Cheque No:'.$data->chq_no ; 
                            } elseif($data->pay_type == 2){
                                echo "Bank Reciept <br>";  
                                echo 'Reciept No:'.$data->chq_no ;  
                            }else{
                                echo "Online Transation <br>";  
                                echo 'Transation No:'.$data->chq_no ; 
                            }
                            ?> <br>
                        </p>
                    </td>
                ...
                <tr class="tabletitle">
                    ...
                    <td class="payment"><h2>{{$data->credit}} Tk</h2></td>
                </tr>
        ...
        <div id="legalcopy">
            <p class="legal " ><strong>Membership Receipt</strong></p>
        </div>
    </div>
</div>
