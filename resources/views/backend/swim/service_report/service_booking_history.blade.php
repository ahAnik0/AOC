...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            @include('backend.swim.service_report.service_booking_history_search')
...
@include('backend.swim.service_report.due_model')
@endsection
@push('js')
    ...
    @include('backend.swim.service_report.service_booking_history_js')
@endpush
