...
<div id="invoice-POS">
    ...
    <div id="bot">
        ...
        <div id="table">
            <table class="css_1" border="1">
                ...
                <tr class="service">
                    ...
                    <td class="tableitem"><p class="itemtext css_2" >{{implode(PHP_EOL, str_split($service->name_of_guests, 5))}}</p></td>
                    <td class="tableitem"><p class="itemtext"></p>-</td>
                </tr>
                ...
                <tr class="tabletitle">
                    ...
                    <td class="payment"><h2>{{$service->total_amount}} Tk</h2></td>
                </tr>
                
                <tr class="tabletitle">
                    <td></td>
                    <td class="Rate"><h2>Due</h2></td>
                    <td class="payment"><h2>{{$service->due}} Tk</h2></td>
                </tr>
        ...
        <div id="legalcopy">
            <p class="legal css_1" ><strong>Service name: {{$service->service_name}}</strong></p>
            <p class="legal css_3" ><strong>Service ID: {{$service->id}}</strong></p>
        </div>
    </div>
</div>
